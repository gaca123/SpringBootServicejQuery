...
public class Referee implements Comparable<Referee>{
    ...
    private int id;
    @Attributes(required = true, title = "Name", description = "Insert name", readonly = false, maxLength = 20, minLength = 2, pattern = "^[a-zA-Z]+")
    private String name;
    ...
    public int compareTo(Referee referee) {
        return this.getName().compareTo(referee.getName());
    }
}
